  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        const top4 = response.data.slice(0, 6);
        setTopProducts(top4);
      })
      .catch((error) => {
  ...
  return (
    <>
      ...
      <div className="max-w-[90%] md:max-w-[80%] mx-auto mt-20">
        ...
        />
        <h1 className="-mb-2 mt-8 font-thin text-3xl ">Explore By Categories</h1>
        <div className="px-10 flex justify-between gap-5 items-center text-center overflow-x-scroll cat-list mb-6">
