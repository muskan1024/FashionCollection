  ...
  return (
    ...
    <div className=''>
      ...
      <div className=" relative flex max-w-[90%] md:max-w-[70%] mx-auto">
        ...
        <h3 className='absolute w-[100%] top-[80%] bg-white translate-y-[-50%] py-[0.5rem] md:py-[1rem] text-center font-extrabold text-[20px] md:text-[2rem] mix-blend-screen '>Best Tailor & Fabrics Seller</h3>
      </div>
      ...
      <div className=" grid max-w-[90%] md:max-w-[80%] mx-auto sm:grid-cols-2 md:grid-cols-3  p-3 gap-9 sm:gap-8 text-center justify-between  ">
        ...
        <Place sx={{ fontSize: 17 }} />
          <a className="hover:text-blue-700 hover:font-semibold"
            target="blank"
